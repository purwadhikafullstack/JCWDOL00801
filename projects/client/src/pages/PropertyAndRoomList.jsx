            ...
            {roomList.map((val, idx) => {
              const getContent = (selected, modal) => {
                ...
                if(modal === "specialprice"){
                  ...
                  const endpoint = `/room-availability/all?id=${val.roomId}&limit=${limitModal}&page=${
                    selected || 0
                  }`
                  Axios.get(process.env.REACT_APP_API_BASE_URL + endpoint)
                  .then(response => {
              ...
              return (
                <Tr key={idx}>
                  ...
                  <Td>
                    ...
                    >
                      <option hidden value="">Action</option>
                      <option
                        onClick={() => {
                          setCurrentModal("avail");
                          getContent(0, "avail");
                        ...
                        {currentModal === "avail" ? (
                                        ...
                                        return (
                                          <>
                                            <Tr>
                                              ...
                                              <Td>
                                                {new Date(val.endDate).toString().substring(0, 24)}
                                              </Td>
                                              <Td>
                                                <Button
                                                  variant={"outline"}
                                      ...
                                      {modalDataPrice.map((val) => {
                                        ...
                                        return (
                                          <Tr>
                                            ...
                                            <Td>{val.name}</Td>
                                            <Td>
                                              {new Date(val.startDate).toString().substring(4, 24)}
                                            </Td>
                                            <Td>
                                              {new Date(val.endDate).toString().substring(4, 24)}
                                            </Td>
                                            <Td>
                                            ...
                                            <Td>
                                              <Button variant={"outline"} colorScheme="green" onClick={deleteHandlerPrice}>Delete</Button>
                                            </Td>
                                          </Tr>
                                        );
                                      })}{" "}
                          ...
                          <Box>
                            ...
                            <Text fontSize={"14px"} mb={2}>
                              ...
                              <span style={{ fontWeight: 600 }}>DESCLAIMER:</span> The special price
                              will also be added to other rooms that have the same type
                            </Text>
                            <CalendarDateRange direction="vertical" />
                            <RadioGroup
                              colorScheme="green"
                            ...
                            <Box>
                              {radioValue === "nominal" ? (
                                ...
                                <>
                                  ...
                                  <Text>
                                    <span style={{ color: "red" }}>*</span> Use " - " to discount
                                    your type price:
                                  </Text>
