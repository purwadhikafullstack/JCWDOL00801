...
function RoomCard(props) {
  ...
  const bookNowHandler = () => {
    if (!email) {
      ...
      navigate(`/payment?id=${props.id}`, {state: {id: props.id, startDate: props.startDate, endDate: props.endDate, typeId: props.data.typeId}})
      window.scrollTo(0,0)
    }
  };
      ...
      <CardBody>
        ...
        <Flex justify="end" align="center">
          <Text color="blue.600" fontWeight="bold" fontSize="2xl">
            {parseInt(props.data.price).toLocaleString("id", {style: "currency", currency: "IDR"})}
          </Text>
